# Aleksandr Simunin — Project Case Studies

[English](README.md) | [Русский](README_RU.md)

This catalog summarizes independently developed portfolio projects. Linked repositories are public source exports; other entries are described without source code where a public release could expose private integrations, operational data, or materials with unclear redistribution rights.

| Project | Focus | Stack / delivered work | Availability |
| --- | --- | --- | --- |
...
| [LectureVault](https://github.com/Mastn1kth/lecturevault) | Lecture recording and notes | Android Kotlin, background recording, Groq Whisper, Gemini, Obsidian, encrypted BYOK storage | Public repository |
...
| [Pet Translator AI](https://github.com/Mastn1kth/pet-translator-ai) | On-device pet media app | React Native, Expo, TFLite, audio and camera flows, notifications | Public repository |
| [Casino Mini App](https://github.com/Mastn1kth/casino-mini-app) | Telegram Mini App demo | FastAPI, SQLite, WebSocket, Telegram auth, virtual coins only | Public repository |
| [AI/IT News Bot](https://github.com/Mastn1kth/ai-news-bot) | News automation | Python, RSS/Atom, scoring, deduplication, SQLite, Docker, Telegram Bot API | Public repository |
...
| Alarm App | Mobile alarm prototype | Flutter, local storage, notifications, app state and tests | Case study only |
...
Public repositories are clean exports. They exclude environment files, API keys, signing credentials, local databases, logs, user data and build artifacts. Dependabot and GitHub vulnerability alerts are enabled for the newly published repositories.
